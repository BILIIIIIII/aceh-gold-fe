...
const SummaryCards = ({
  ...
  const renderpercentChange = () => {
    ...
    if (isPercentage && absoluteChange !== undefined) {
      ...
      return (
        <div className="flex gap-1 dark:bg-zinc-900 ">
    ...
    if (isHigh) {
      return (
        <div className="flex items-baseline gap-4 dark:bg-zinc-900 border-red-400 ">
  ...
  return (
    <Card className="bg-transparent shadow-none border-none m-0 p-0">
      <CardContent className="bg-transparent flex flex-col justify-between m-0 p-0 gap-2">
        <span
